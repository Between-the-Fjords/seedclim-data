...
load("/Users/fja062/Desktop/SeedClim-Climate-Data/GriddedMonth_AnnualClimate2009-2016.Rdata")
head(monthlyClimate)
...
load("/Users/fja062/Desktop/SeedClim-Climate-Data/GriddedDailyClimateData2009-2016.Rdata")
head(climate)
