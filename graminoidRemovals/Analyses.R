...
coefEst <- plot_grid(coefEst, labels = c("A                                                       B"), label_x = 0)

ggsave(coefEst, filename = "fig16coefEst_v4.jpg", height = 10, width = 8, dpi = 300, path = "/Users/fja062/Documents/seedclimComm/figures")
