...
#richness
trait_rich_all_nabd <- replicated_pd_abd_std(comm_matrix = cover_binary,phylogeny_directory = "phylogeny/trait_scaled_phylogenies/",n_reps_phylo = 100,nreps_null = 100)
cover.meta$trait_rich_all_nabd<-rowMeans(trait_rich_all_nabd)

save.image("C:/Users/Brian/Desktop/current_projects/seedclimComm/temp.RData")


#divergence
trait_mpd_std <- replicated_mpd_abd_std(comm_matrix = cover_binary,phylogeny_directory = "phylogeny/trait_scaled_phylogenies/",n_reps_phylo = 100,nreps_null = 100)
cover.meta$trait_mean_all_nabd <- rowMeans(trait_mpd_std)

trait_mntd_std <- replicated_mntd_abd_std(comm_matrix = cover_binary,phylogeny_directory = "phylogeny/trait_scaled_phylogenies/",n_reps_phylo = 100,nreps_null = 100)
cover.meta$trait_mean_near_nabd <- rowMeans(trait_mntd_std)

save.image("C:/Users/Brian/Desktop/current_projects/seedclimComm/temp.RData")


#variance
trait_vpd_std <- replicated_vpd_abd_std(comm_matrix = cover_binary,phylogeny_directory = "phylogeny/trait_scaled_phylogenies/",n_reps_phylo = 100,nreps_null = 100)
cover.meta$trait_var_all_nabd<-rowMeans(trait_vpd_std)

trait_vntd_std <- replicated_vntd_abd_std(comm_matrix = cover_binary,phylogeny_directory = "phylogeny/trait_scaled_phylogenies/",n_reps_phylo = 100,nreps_null = 100)
cover.meta$trait_var_near_nabd <- rowMeans(trait_vntd_std)
